package ar.coop.arena.security.client;
...
import ar.coop.arena.security.client.ui.desktop.Desktop;
...
public class ClientSession extends AbstractClientSession {
  ...
  public void execLoadSession() throws ProcessingException {
    ...
    CODES.getAllCodeTypes(ar.coop.arena.security.shared.Activator.PLUGIN_ID);
